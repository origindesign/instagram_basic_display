<?php
/**
 * @file Contains \Drupal\instagram_basic_display\InstagramBasicDisplayApi
 */

namespace Drupal\instagram_basic_display;


use Drupal\instagram_basic_display\InstagramBasicDisplayException;


/**
 * Instagram Graph API class
 *
...
class InstagramBasicDisplayApi{
  ...
  public function setConfig($config = null)
  {
    if (is_array($config)) {
      ...
      throw new InstagramBasicDisplayException('Error: setConfig() - Configuration data is missing.');
    }
  }
